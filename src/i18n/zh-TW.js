...
t.brand = {}
t.brand.lg = '門磁設備服務雲平台'
t.brand.mini = '門磁設備服務雲平台'
...
t.login.captcha = '驗證碼'
t.login.demo = '在線演示'
t.login.copyright = '门磁设备服务云平台'
t.login.remmberPassword = '記住密碼'
t.login.register = '免費註冊'
t.login.forgetPassword = '忘記密碼'
t.login.viewHelp = '查看幫助'
...
t.oss.aliyunDomainTips = '阿里雲綁定的域名，如：http://cdn.dingiiot.com'
...
t.oss.localDomainTips = '綁定的域名，如：http://cdn.dingiiot.com'
t.oss.fastdfsDomain = '域名'
t.oss.fastdfsDomainTips = '綁定的域名，如：http://cdn.dingiiot.com'
...
//项目
t.project = {}
t.project.projectName = "項目名稱"
t.project.location = '位置'
t.project.link = '項目組態頁面鏈接'
t.project.createDate = '創建時間'
t.project.creator = '創建者'
t.project.configuration = "組態"

//网关
t.gwsn = {};
t.gwsn.belongProject = "所屬項目"
t.gwsn.enter = "請輸入編號或備註"
t.gwsn.onlyOnline = "僅在線"
t.gwsn.number = "網關編號"
t.gwsn.gwsnPassword = "網關密碼"
t.gwsn.gwsnLastTime = "最後更新時間"
t.gwsn.signalValue = "信號值"
t.gwsn.gwsnNote = "網關備註"
t.gwsn.gwsnModel = "網關型號"
t.gwsn.gwsnHardv = "網關硬件版本"
t.gwsn.gwsnsoftV = "網關軟件版本"
t.gwsn.config = "配置"
t.gwsn.configuration = "組態"
t.gwsn.isCopy = "是否復制數據"
t.gwsn.enterGwsn = "請輸入網關編號"
t.gwsn.enterPassword = "請輸入網關密碼"
t.gwsn.copyDataSource = "復制數據源"
t.gwsn.config = "網關配置"
t.gwsn.projectConfig = "項目配置"
t.gwsn.bindProjectName = "綁定項目名"
t.gwsn.submit = "提交"
t.gwsn.basicConfig = "基本配置"
t.gwsn.limitgwsnNote = "網關備註(16個漢字以內)"
t.gwsn.refresh = "刷新"
t.gwsn.setting = "設置"
t.gwsn.hardv = "硬件版本"
t.gwsn.softV = "軟件版本"
t.gwsn.time = "網關時間"
t.gwsn.timeZone = "網關時區"
t.gwsn.IPconfig = "IP設置"
t.gwsn.IPinfo = "網關IP信息"
t.gwsn.networkCard = "網卡"
t.gwsn.isEnable = "是否啟用"
t.gwsn.IPMode = "IP獲取方式"
t.gwsn.IPaddress = "IP地址"
t.gwsn.subnetMask = "子網掩碼"
t.gwsn.defaultgateway = "默認網關"
t.gwsn.isdefaultRoute = "是否設為默認路由"
t.gwsn.route = "路由"
t.gwsn.updateSoftV = "升級軟件"
t.gwsn.currentVersion = "當前軟件版本"
t.gwsn.selectVersion = "選擇升級軟件版本"
t.gwsn.restart = "重啟"
t.gwsn.upgrade = "升級"
t.gwsn.demotion = "降級"
t.gwsn.yes = "是"
t.gwsn.no = "否"
t.gwsn.assestIp = "靜態IP"
